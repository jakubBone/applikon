      ...
      {selected ? (
        <div className="details-sections">
          ...
          <CollapsibleSection
            ...
            dataCy="section-general"
            action={<button className="prep-edit-link" data-cy="edit-general" onClick={() => setEditGlobal(true)}>{t('cheatSheet.edit')}</button>}
          >
